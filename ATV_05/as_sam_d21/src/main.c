...

{
    ...
    {
        contador++;
        // Liga outro LED ou realiza uma operação específica
        port_pin_set_output_level(LED_1_PIN, LED_0_ACTIVE);  // Liga o LED 1
        TarefaEspera(500);  // Espera por 500ms

        port_pin_set_output_level(LED_1_PIN, !LED_0_ACTIVE); // Desliga o LED 1
        TarefaEspera(500);  // Espera por 500ms
    }
}
